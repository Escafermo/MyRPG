...
public class CameraRaycasterEditor : Editor
{
    ...
    #region TESTING print a string from the Custom Raycaster Editor
    //void PrintString()
    //{
    //    string currentPrint = serializedObject.FindProperty("stringToPrint").stringValue;

    //    string thisPrint = EditorGUILayout.TextField("String to print: ", currentPrint);
    //    if (thisPrint != currentPrint)
    //    {
    //        serializedObject.FindProperty("stringToPrint").stringValue = thisPrint;
    //    }
    //}
    #endregion
}
